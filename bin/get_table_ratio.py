...
tsv_single_tag = sys.argv[10]
class_single_tag = sys.argv[11]
tsv_multiple_tag = sys.argv[12]
class_multiple_tag = sys.argv[13]
tsv_any_tag = sys.argv[14]
class_any_tag = sys.argv[15]
tsv_single_tag_precise_tag = sys.argv[16]
class_single_tag_precise_tag = sys.argv[17]
tsv_single_tag_5indel = sys.argv[18]
class_single_tag_5indel = sys.argv[19]
tsv_single_tag_3indel = sys.argv[20]
class_single_tag_3indel = sys.argv[21]
tsv_single_tag_anyindel = sys.argv[22]
class_single_tag_anyindel = sys.argv[23]
...
dfs = [df_total, df_no_tag_indel, df_no_tag_deletion, df_no_tag_insertion, df_single_tag, df_multiple_tag, df_any_tag, df_single_tag_precise_tag, df_single_tag_5indel, df_single_tag_3indel, df_single_tag_anyindel]
...
df_merge.to_csv(out_tsv, sep = "\t", index = None)
# %%
