process CLASSIFY_NO_TAG {
    ...
    tuple val(meta), path("03e_tmp_indel_pos/*.csv"), emit: indel_pos 
    ...
    parse_bam_indel.py 03d_tmp_bam/${prefix}.bam $ref 03e_tmp_indel_pos/${prefix}.csv

    # Step3: split reads into indel, deletion, and insertion using #2 results
    mkdir 03a_indel 03b_deletion 03c_insertion
    classify_no_tag.py 03e_tmp_indel_pos/${prefix}.csv $reads \
    $pam_start \
